...
mod tests {
    ...
    #[test]
    fn test_key_modifiers_basics() {
        let mut modifiers = KM_LSHIFT;
        assert_eq!(0b1, modifiers.0);

        modifiers |= KM_RSHIFT;
        assert_eq!(0b11, modifiers.0);

        modifiers |= KM_SHIFT;
        assert_eq!(0b111, modifiers.0);

        modifiers |= KM_RWIN;
        assert_eq!(0b10000000111, modifiers.0);
    }

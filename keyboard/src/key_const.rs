...
static KEY_NAMES: [(&'static str, Key); MAX_KEYS] = [
    ...
    new_key!("BROWSER_HOME", 0xAC, 0x32, true),
    ...
    new_key!("LAUNCH_APP1", 0xB6, 0x6B, true),
    new_key!("LAUNCH_APP2", 0xB7, 0x21, true),
    ...
    new_key!("MEDIA_PLAY_PAUSE", 0xB3, 0x22, true),
    new_key!("MEDIA_PREV_TRACK", 0xB1, 0x10, true),
    ...
    new_key!("_none_", 0xFF, 0x00, false),
];

...
mod tests {
    ...
    #[test]
    fn test_vk_display() {
        assert_eq!("VK_RETURN [0x0D]", format!("{}", VirtualKey::parse("VK_RETURN").unwrap()));
    }
    ...
    #[test]
    fn test_sc_display() {
        assert_eq!("SC_ENTER [0x001C]", format!("{}", ScanCode::parse("SC_ENTER").unwrap()));
    }
    ...
    fn test_key_code_display() {
        assert_eq!("SC_ENTER [0x001C]", format!("{}", KeyCode::parse("SC_ENTER").unwrap()));
        assert_eq!("VK_RETURN [0x0D]", format!("{}", KeyCode::parse("VK_RETURN").unwrap()));
    }

...
pub(crate) static KEY_MOUSE_X: Key = new_key!("MOUSE_X", 0xF0, 0x00, true);
pub(crate) static KEY_MOUSE_Y: Key = new_key!("MOUSE_Y", 0xF2, 0x00, true);
...
pub(crate) static KEY_WHEEL_X: Key = new_key!("WHEEL_X", 0xF1, 0x00, true);
pub(crate) static KEY_WHEEL_Y: Key = new_key!("WHEEL_Y", 0xF3, 0x00, true);
...
pub(crate) static CODE_TO_KEY_MAP: phf::Map<u32, Key> = phf_map! {
    ...
    0xE70000 => KEY_PACKET,
    0xF00001 => KEY_MOUSE_X,
    0xF10001 => KEY_WHEEL_X,
    0xF20001 => KEY_MOUSE_Y,

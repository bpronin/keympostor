...
pub static KEYS: [(&'static str, Key); MAX_KEYS] = [
    new_key_entry!("	", 0x00, 0x0F, true),
    new_key_entry!("", 0x00, 0x01, true),
    new_key_entry!("0", 0x30, 0x0B, false),
    new_key_entry!("1", 0x31, 0x02, false),
    new_key_entry!("2", 0x32, 0x03, false),
    new_key_entry!("3", 0x33, 0x04, false),
    new_key_entry!("4", 0x34, 0x05, false),
    new_key_entry!("5", 0x35, 0x06, false),
    new_key_entry!("6", 0x36, 0x07, false),
    new_key_entry!("7", 0x37, 0x08, false),
    new_key_entry!("8", 0x38, 0x09, false),
    new_key_entry!("9", 0x39, 0x0A, false),
    new_key_entry!("<00>", 0x00, 0x54, true),
    new_key_entry!("A", 0x41, 0x1E, false),
    new_key_entry!("ACCEPT", 0x1E, 0x00, false),
    new_key_entry!("APOSTROPHE", 0xDE, 0x28, false),
    new_key_entry!("APPLICATION", 0x5D, 0x5D, true),
    new_key_entry!("ATTN", 0xF6, 0x00, false),
    new_key_entry!("B", 0x42, 0x30, false),
    new_key_entry!("BACKSLASH", 0xDC, 0x2B, false),
    new_key_entry!("BACKSLASH_2", 0xE2, 0x56, false),
    new_key_entry!("BACKSPACE", 0x08, 0x0E, false),
    new_key_entry!("BACKTICK", 0xC0, 0x29, false),
    new_key_entry!("BREAK", 0x03, 0x46, true),
    new_key_entry!("BRIGHTNESS", 0x00, 0x2B, true),
    new_key_entry!("BROWSER_BACK", 0xA6, 0x6A, true),
    new_key_entry!("BROWSER_FAVORITES", 0xAB, 0x66, true),
    new_key_entry!("BROWSER_FORWARD", 0xA7, 0x69, true),
    new_key_entry!("BROWSER_HOME", 0xAC, 0x00, true),
    new_key_entry!("BROWSER_REFRESH", 0xA8, 0x67, true),
    new_key_entry!("BROWSER_SEARCH", 0xAA, 0x00, true),
    new_key_entry!("BROWSER_STOP", 0xA9, 0x68, true),
    new_key_entry!("C", 0x43, 0x2E, false),
    new_key_entry!("CAPS_LOCK", 0x14, 0x3A, false),
    new_key_entry!("COMMA", 0xBC, 0x33, false),
    new_key_entry!("CONVERT", 0x1C, 0x00, false),
    new_key_entry!("CRSEL", 0xF7, 0x00, false),
    new_key_entry!("CTRL", 0x11, 0x1D, false),
    new_key_entry!("D", 0x44, 0x20, false),
    new_key_entry!("DELETE", 0x2E, 0x53, true),
    new_key_entry!("DOT", 0xBE, 0x34, false),
    new_key_entry!("DOWN", 0x28, 0x50, true),
    new_key_entry!("E", 0x45, 0x12, false),
    new_key_entry!("END", 0x23, 0x4F, true),
    new_key_entry!("ENTER", 0x0D, 0x1C, false),
    new_key_entry!("EQ", 0xBB, 0x0D, false),
    new_key_entry!("EREOF", 0xF9, 0x5D, false),
    new_key_entry!("ESC", 0x1B, 0x01, false),
    new_key_entry!("EXECUTE", 0x2B, 0x00, false),
    new_key_entry!("EXSEL", 0xF8, 0x00, false),
    new_key_entry!("F", 0x46, 0x21, false),
    new_key_entry!("F1", 0x70, 0x3B, false),
    new_key_entry!("F10", 0x79, 0x44, false),
    new_key_entry!("F11", 0x7A, 0x57, false),
    new_key_entry!("F12", 0x7B, 0x58, false),
    new_key_entry!("F13", 0x7C, 0x64, false),
    new_key_entry!("F14", 0x7D, 0x65, false),
    new_key_entry!("F15", 0x7E, 0x66, false),
    new_key_entry!("F16", 0x7F, 0x67, false),
    new_key_entry!("F17", 0x80, 0x68, false),
    new_key_entry!("F18", 0x81, 0x69, false),
    new_key_entry!("F19", 0x82, 0x6A, false),
    new_key_entry!("F2", 0x71, 0x3C, false),
    new_key_entry!("F20", 0x83, 0x6B, false),
    new_key_entry!("F21", 0x84, 0x6C, false),
    new_key_entry!("F22", 0x85, 0x6D, false),
    new_key_entry!("F23", 0x86, 0x6E, false),
    new_key_entry!("F24", 0x87, 0x76, false),
    new_key_entry!("F3", 0x72, 0x3D, false),
    new_key_entry!("F4", 0x73, 0x3E, false),
    new_key_entry!("F5", 0x74, 0x3F, false),
    new_key_entry!("F6", 0x75, 0x40, false),
    new_key_entry!("F7", 0x76, 0x41, false),
    new_key_entry!("F8", 0x77, 0x42, false),
    new_key_entry!("F9", 0x78, 0x43, false),
    new_key_entry!("FINAL", 0x18, 0x00, false),
    new_key_entry!("FN_BROWSER_HOME", 0xAC, 0x32, true),
    new_key_entry!("FN_BROWSER_SEARCH", 0xAA, 0x65, true),
    new_key_entry!("FN_LAUNCH_APP1", 0xB6, 0x6B, true),
    new_key_entry!("FN_LAUNCH_APP2", 0xB7, 0x21, true),
    new_key_entry!("FN_LAUNCH_MAIL", 0xB4, 0x6C, true),
    new_key_entry!("FN_MEDIA_NEXT_TRACK", 0xB0, 0x19, true),
    new_key_entry!("FN_MEDIA_PLAY_PAUSE", 0xB3, 0x22, true),
    new_key_entry!("FN_MEDIA_PREV_TRACK", 0xB1, 0x10, true),
    new_key_entry!("FN_VOLUME_DOWN", 0xAE, 0x2E, true),
    new_key_entry!("FN_VOLUME_MUTE", 0xAD, 0x20, true),
    new_key_entry!("FN_VOLUME_UP", 0xAF, 0x30, true),
    new_key_entry!("G", 0x47, 0x22, false),
    new_key_entry!("H", 0x48, 0x23, false),
    new_key_entry!("HANJA", 0x19, 0x00, false),
    new_key_entry!("HELP", 0x2F, 0x63, false),
    new_key_entry!("HOME", 0x24, 0x47, true),
    new_key_entry!("I", 0x49, 0x17, false),
    new_key_entry!("IME_OFF", 0x1A, 0x00, false),
    new_key_entry!("IME_ON", 0x16, 0x00, false),
    new_key_entry!("INSERT", 0x2D, 0x52, true),
    new_key_entry!("J", 0x4A, 0x24, false),
    new_key_entry!("JUNJA", 0x17, 0x00, false),
    new_key_entry!("K", 0x4B, 0x25, false),
    new_key_entry!("KANA", 0x15, 0x00, false),
    new_key_entry!("L", 0x4C, 0x26, false),
    new_key_entry!("LAUNCH_APP1", 0xB6, 0x00, true),
    new_key_entry!("LAUNCH_APP2", 0xB7, 0x00, true),
    new_key_entry!("LAUNCH_MAIL", 0xB4, 0x00, true),
    new_key_entry!("LAUNCH_MEDIA_SELECT", 0xB5, 0x6D, true),
    ...
    new_key_entry!("M", 0x4D, 0x32, false),
    new_key_entry!("MEDIA_NEXT_TRACK", 0xB0, 0x00, true),
    new_key_entry!("MEDIA_PLAY_PAUSE", 0xB3, 0x00, true),
    ...
    new_key_entry!("NONAME", 0xFC, 0x00, false),
    new_key_entry!("NON_CONVERT", 0x1D, 0x00, false),
    new_key_entry!("NUM_0", 0x60, 0x52, false),
    new_key_entry!("NUM_1", 0x61, 0x4F, false),
    new_key_entry!("NUM_2", 0x62, 0x50, false),
    new_key_entry!("NUM_3", 0x63, 0x51, false),
    new_key_entry!("NUM_4", 0x64, 0x4B, false),
    new_key_entry!("NUM_5", 0x65, 0x4C, false),
    new_key_entry!("NUM_6", 0x66, 0x4D, false),
    new_key_entry!("NUM_7", 0x67, 0x47, false),
    new_key_entry!("NUM_8", 0x68, 0x48, false),
    new_key_entry!("NUM_9", 0x69, 0x49, false),
    new_key_entry!("NUM_CLEAR", 0x0C, 0x4C, false),
    new_key_entry!("NUM_DELETE", 0x2E, 0x53, false),
    new_key_entry!("NUM_DIV", 0x6F, 0x35, true),
    new_key_entry!("NUM_DOT", 0x6E, 0x53, false),
    new_key_entry!("NUM_DOWN", 0x28, 0x50, false),
    new_key_entry!("NUM_END", 0x23, 0x4F, false),
    new_key_entry!("NUM_ENTER", 0x0D, 0x1C, true),
    new_key_entry!("NUM_HOME", 0x24, 0x47, false),
    new_key_entry!("NUM_INSERT", 0x2D, 0x52, false),
    new_key_entry!("NUM_LEFT", 0x25, 0x4B, false),
    new_key_entry!("NUM_LOCK", 0x90, 0x45, true),
    new_key_entry!("NUM_LOCK_2", 0x13, 0x45, true), /* CTRL + NUM_LOCK*/
    new_key_entry!("NUM_MINUS", 0x6D, 0x4A, false),
    new_key_entry!("NUM_MUL", 0x6A, 0x37, false),
    new_key_entry!("NUM_PAGE_DOWN", 0x22, 0x51, false),
    new_key_entry!("NUM_PAGE_UP", 0x21, 0x49, false),
    new_key_entry!("NUM_PLUS", 0x6B, 0x4E, false),
    new_key_entry!("NUM_RIGHT", 0x27, 0x4D, false),
    new_key_entry!("NUM_UP", 0x26, 0x48, false),
    new_key_entry!("O", 0x4F, 0x18, false),
    new_key_entry!("OEM_8", 0xDF, 0x00, false),
    new_key_entry!("OEM_CLEAR", 0xFE, 0x00, false),
    new_key_entry!("P", 0x50, 0x19, false),
    new_key_entry!("PA1", 0xFD, 0x00, false),
    new_key_entry!("PACKET", 0xE7, 0x00, false),
    new_key_entry!("PAGE_DOWN", 0x22, 0x51, true),
    new_key_entry!("PAGE_UP", 0x21, 0x49, true),
    new_key_entry!("PAUSE", 0x13, 0x45, false),
    new_key_entry!("PLAY", 0xFA, 0x00, false),
    new_key_entry!("PLUS", 0x00, 0x4E, true),
    new_key_entry!("PRINT", 0x2A, 0x00, false),
    new_key_entry!("PRINT_SCREEN", 0x2C, 0x37, true),
    new_key_entry!("PROCESS_KEY", 0xE5, 0x00, false),
    new_key_entry!("Q", 0x51, 0x10, false),
    new_key_entry!("R", 0x52, 0x13, false),
    ...
    new_key_entry!("RIGHT_WIN", 0x5C, 0x5C, true),
    new_key_entry!("S", 0x53, 0x1F, false),
    new_key_entry!("SCROLL_LOCK", 0x91, 0x46, false),
    new_key_entry!("SELECT", 0x29, 0x00, false),
    new_key_entry!("SEMICOLON", 0xBA, 0x27, false),
    new_key_entry!("SEPARATOR", 0x6C, 0x00, false),
    new_key_entry!("SHIFT", 0x10, 0x2A, false),
    new_key_entry!("SLASH", 0xBF, 0x35, false),
    new_key_entry!("SLEEP", 0x5F, 0x5F, true),
    new_key_entry!("SPACE", 0x20, 0x39, false),
    new_key_entry!("SYS_REQ", 0x2C, 0x54, false),
    new_key_entry!("T", 0x54, 0x14, false),
    new_key_entry!("TAB", 0x09, 0x0F, false),
    new_key_entry!("U", 0x55, 0x16, false),
    new_key_entry!("UNASSIGNED", 0, 0, false),
    new_key_entry!("UP", 0x26, 0x48, true),
    new_key_entry!("V", 0x56, 0x2F, false),
    new_key_entry!("VOLUME_DOWN", 0xAE, 0x00, true),
    new_key_entry!("VOLUME_MUTE", 0xAD, 0x00, true),
